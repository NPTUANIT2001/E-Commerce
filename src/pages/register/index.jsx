...
const Register = () => {
  ...
  const handleSubmit = () => {
    ...
    alert(isValid ? "Register success!!!" : "Please fill out all the fields!!!");
  }
  return (
    <>
      <Formik
              ...
              <div className="col-md-6 right-box">
                  <div className="row align-items-center">
                        ...
                        <div className="input-group mb-3">
                            <input type="text" className="form-control form-control-lg bg-light fs-6" placeholder="Email address" value={values.email} onChange={handleChange}/>
                            {errors.email && <span className="error">{errors.email}</span>}
                        </div>
                        <div className="input-group mb-1">
                            <input type="password" className="form-control form-control-lg bg-light fs-6" placeholder="Password" value={values.password} onChange={handleChange} />
                            {errors.password && <span className="error">{errors.password}</span>}
                        </div>
                        <div className="input-group mb-5 d-flex justify-content-between">
                            <div className="forgot">
                                <small><a href="#">Do you already have an account? <span>Login</span></a></small>
                            </div>
                        </div>
                        <div className="input-group mb-3">
